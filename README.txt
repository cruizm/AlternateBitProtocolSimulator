...
3 - Run the simulator
	...
	3 - To compile the project, type in the terminal:
		make clean; make all
	4 - To run the simulation, type in the terminal "./NAME_OF_THE_COMPILED_FILE NAME_OF_THE_INPUT_FILE". For this test you need to type: ./ABP ../data/input_abp_0.txt
	5 - To check the output of the simulation, go to the following directory  "data/abp_output.txt"
